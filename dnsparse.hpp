...
#line 90 "dnsparse.hpp.rl"
    int cs;

#line 57 "dnsparse.hpp"
	{
	cs = escaped_dnsname_start;
	}

#line 92 "dnsparse.hpp.rl"
    unsigned nlen = 0;
    unsigned llen = 0;
    char decb = 0;

#line 67 "dnsparse.hpp"
	{
	switch ( cs )
	{
case 1:
...
cs = 0;
	goto _out;
tr0:
#line 23 "dnsparse.hpp.rl"
	{
        llen = 0;
    }
#line 28 "dnsparse.hpp.rl"
	{
        ++llen;
        labelfun ((*p));
    }
...
st5:
	p += 1;
case 5:
#line 14 "dnsparse.hpp.rl"
	{ decb *= 10; }
#line 13 "dnsparse.hpp.rl"
	{ decb += (*p) - '0'; }
#line 251 "dnsparse.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto st6;
	goto st0;
st6:
